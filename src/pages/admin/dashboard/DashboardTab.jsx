                                                            ...
                                                            <div className="flex gap-2">
                                                                <div className="flex gap-2 cursor-pointer text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                                    ...
                                                                    <Link to='/updateproduct' onClick={() => edithandle(item)}>
                                                                        <div>
                                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                                                                <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 2.487a3.375 3.375 0 114.773 4.773L7.06 21.835a4.5 4.5 0 01-1.688 1.093l-4.028 1.343a.375.375 0 01-.48-.48l1.342-4.028a4.5 4.5 0 011.094-1.688L16.862 2.487zm0 0L19.5 5.625" />
                                                                            </svg>
                                                                        </div>
                                                                    </Link>
                                                                </div>
