...
function DashboardTab() {
    ...
    // Debugging log to check if data is coming from context correctly
    useEffect(() => {
    ...
    const handleStatusChange = (orderId, newStatus) => {
        const updatedOrder = { ...order.find((o) => o.id === orderId) };
    ...
    const getOptionColor = (mode, status) => {
        return mode === 'dark' ? 'white' : getStatusColor(status);
    };
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            >
                                                                                <path
                                                                                    strokeLinecap="round"
                                                                                    strokeLinejoin="round"
                                                                                    d="M16.862 2.487a3.375 3.375 0 114.773 4.773L7.06 21.835a4.5 4.5 0 01-1.688 1.093l-4.028 1.343a.375.375 0 01-.48-.48l1.342-4.028a4.5 4.5 0 011.094-1.688L16.862 2.487zm0 0L19.5 5.625"
                                                                                />
                                                                            </svg>
                                                                        </div>
                                                                    </Link>
                                        ...
                                        <tbody>
                                            {order.flatMap((allorder, orderIndex) =>
                                                allorder.cartItems.map((item, itemIndex) => {
                                                    ...
                                                    const serialNumber =
                                                        orderIndex * allorder.cartItems.length +
                                                        itemIndex +
                                                        1;
                                                    return (
                                                        <tr
                                                        ...
                                                        >
                                                            ...
                                                            <td
                                                                className="px-6 py-4"
                                                                style={{ color: getOptionColor(mode, order[orderIndex].status) }}
                                                            >
                                                                {order[orderIndex].status}
                                                            </td>
                                                            <td className="px-6 py-4">
                                                                <select
                                                                    value={status}
                                                                    ...
                                                                    style={mode === "dark" ? selectStyle : { color: getStatusColor(status) }}
                                                                >
                                                                    <option value="Pending" style={{ color: getOptionColor(mode, "Pending") }}>Pending</option>
                                                                    <option value="Processed" style={{ color: getOptionColor(mode, "Processed") }}>Processed</option>
                                                                    <option value="Shipped" style={{ color: getOptionColor(mode, "Shipped") }}>Shipped</option>
                                                                    <option value="Delivered" style={{ color: getOptionColor(mode, "Delivered") }}>Delivered</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                    );
