...
function ProductCard() {
    ...
    const { mode, product, searchkey, filterType, filterTitle, filterPrice } = context;
                            ...
                            <div key={index} className="p-4 md:w-1/4 drop-shadow-lg">
                                ...
                                >
                                    ...
                                    <div className="p-5 border-t-2">
                                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1" style={{ color: mode === 'purple' ? 'purple' : '', }}>
                                            E-Bharat
                                        </h2>
