...
function Filter() {
    ...
    return (
        <div>
            <div className='container mx-auto px-4 mt-5' style={{ maxWidth: '1500px' }}>
                <div className="p-5 rounded-lg bg-acaef5 drop-shadow-xl border border-gray-200"
                    style={{
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            style={{
                                backgroundColor: mode === 'dark' ? 'rgb(64 66 70)' : '', // Dark mode input background color
                                color: mode === 'dark' ? 'white' : '', // Dark mode input text color
                            }}
                        />
                    </div>
