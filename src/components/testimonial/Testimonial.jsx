                ...
                <div className="container mx-auto px-5 py-10">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center rounded-lg p-4" style={{ backgroundColor: '#acaef5', color: 'black' }}>
                                ...
                                <p className="leading-relaxed">This website has an amazing selection of musical instruments! I found exactly what I was looking for, and the prices were unbeatable.</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center rounded-lg p-4" style={{ backgroundColor: '#acaef5', color: 'black' }}>
                                ...
                                <p className="leading-relaxed">The customer service is outstanding. They helped me choose the perfect guitar and even offered free shipping. Highly recommend!</p>
                                <span className="inline-block h-1 w-10 rounded bg-white mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center rounded-lg p-4" style={{ backgroundColor: '#acaef5', color: 'black' }}>
                                ...
                                <p className="leading-relaxed">I'm so impressed with the quality of the products. My new keyboard arrived quickly and in perfect condition.</p>
                                <span className="inline-block h-1 w-10 rounded bg-white mt-6 mb-4" />
